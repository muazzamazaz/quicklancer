...
class SiteManagementController extends Controller
{
    ...
    public function settings()
    {
        ...
        $footer_copyright = !empty($footer_settings['copyright']) ? $footer_settings['copyright'] : 'Quiklance. All Rights Reserved.';
    ...
    public function homePageSettings()
    {
        ...
        $banner_bg2 = !empty($home_settings[0]['home_banner2']) ? $home_settings[0]['home_banner2'] : null;
        $banner_bg3 = !empty($home_settings[0]['home_banner3']) ? $home_settings[0]['home_banner3'] : null;
        ...
        return view(
            ...
            compact(
                ...
                'banner_bg','banner_bg2','banner_bg3', 'banner_bg_image', 'company_title', 'company_desc',
