...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $banner2  = !empty($banner_settings['home_banner2']) ? $banner_settings['home_banner2'] : '';
        $banner3  = !empty($banner_settings['home_banner3']) ? $banner_settings['home_banner3'] : '';
        ...
        return view(
            'front-end.index',
            compact(
                'categories', 'banner_settings', 'banner','banner2','banner3', 'banner_inner_image',
