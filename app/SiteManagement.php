            ...
            foreach ($home_settings as $key => $home) {
                ...
                if (!empty($home['home_banner'])) {
                    if (file_exists($old_path . '/' . $home['home_banner'])) {
                        ...
                        $filename = time() . 'u-' . $home['home_banner'];
                ...
                ///////////////////
                if (!empty($home['home_banner2'])) {
                    if (file_exists($old_path . '/' . $home['home_banner2'])) {
                        if (!file_exists($new_path)) {
                            File::makeDirectory($new_path, $mode = 0777, true, true);
                        }
                        $filename2 = time() . 'w-' . $home['home_banner2'];
                        rename($old_path . '/' . $home['home_banner2'], $new_path . '/' . $filename2);
                        $home_settings[$key]['home_banner2'] = $filename2;
                    }
                }
                ///////////////////
                ///////////////////
                if (!empty($home['home_banner3'])) {
                    if (file_exists($old_path . '/' . $home['home_banner3'])) {
                        if (!file_exists($new_path)) {
                            File::makeDirectory($new_path, $mode = 0777, true, true);
                        }
                        $filename3 = time() . 'y-' . $home['home_banner3'];
                        rename($old_path . '/' . $home['home_banner3'], $new_path . '/' . $filename3);
                        $home_settings[$key]['home_banner3'] = $filename3;
                    }
                }
                ////////////////////
