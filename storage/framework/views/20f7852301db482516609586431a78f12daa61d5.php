                                ...
                                <div class="wt-userlistinghold wt-featured wt-userlistingvtwo">
                                    ...
                                    <div class="wt-userlistingcontent">
                                            ...
                                            <?php if(!empty($job->price) || 
                                                ...
                                                <ul class="wt-userlisting-breadcrumb">
                                                    ...
                                                    <?php if(!empty($job->location->title)): ?>
                                                        <li><span><img src="<?php echo e(asset(App\Helper::getLocationFlag($job->location->flag))); ?>" alt="<?php echo e($job->location->title); ?>"> <?php echo e($job->location->title); ?></span></li>
                                                    <?php endif; ?>
                                                </ul>
                                            <?php endif; ?>
                                        </div>
                                        <div class="wt-rightarea">
                                            ...
                                            <?php else: ?> 
                                                <h4><?php echo e(trans('lang.no_freelancers')); ?></h4>
                                            <?php endif; ?>
                                        </div>
                                    </div>	
                                </div>
                                    ...
                                    <div class="wt-userlistinghold wt-featured wt-proposalitem">
                                        ...
                                        <div class="wt-proposaldetails">
                                            ...
                                            <div class="wt-proposalfeedback">
                                                ...
                                                <?php endif; ?>
                                                <span class="wt-starcontent"><?php echo e($rating); ?>&nbsp;<em> (<?php echo e($reviews); ?>)</em></span>
                                            </div>												
                                        </div>
                                                    ...
                                                    <fieldset>
                                                        <div class="form-group">
                                                            <span class="wt-select">
                                                                <?php echo Form::select('status', $project_status, $job->status, array('id' =>'job_status', 'data-placeholder' => trans('lang.select_status'), '@change' => 'jobStatus('.$job->id.', '.$accepted_proposal->id.')')); ?>

                                                            </span>
                                                            <a href="javascrip:void(0);" class="wt-searchgbtn" @click.prevent='jobStatus(<?php echo e($job->id); ?>)'><i class="fa fa-check"></i></a>
                                                        </div>
                                                    </fieldset>
                                                </form>
                                            <?php endif; ?>
                                            <div class="wt-hireduserstatus">
                                                <h5>&#36;<?php echo e($accepted_proposal->amount); ?></h5>
