    ...
    <section class="wt-haslayout wt-dbsectionspace la-dbproposal" id="jobs">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <?php if($proposal->status == "cancelled"): ?>
                    <div class="wt-jobalertsholder">
                        <ul class="wt-jobalerts">
                            <li class="alert alert-danger alert-dismissible fade show">
                                ...
                                <a href="javascript:void(0)" class="wt-alertbtn danger" v-on:click.prevent="viewReason('<?php echo e($proposal->reports['description']); ?>')" ><?php echo e(trans('lang.reason')); ?></a>
