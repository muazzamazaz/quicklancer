<?php $__env->startSection('content'); ?>
    <div id="home" class="la-home-page">
        ...
        <div class="wt-haslayout wt-bannerholder" style="background-image:url(<?php echo e(asset(Helper::getBackgroundImage($banner))); ?>);height: 500px;">
...
<!--
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item active">
      ...
      <img class="d-block w-100" src="<?php echo e(asset(Helper::getBackgroundImage($banner))); ?>" alt="First slide">
      <div class="btn">
                                        <a href="<?php echo e($freelancer_url); ?>" class="wt-btn"><?php echo e(trans('lang.join_now')); ?></a>
                                    </div>
                                </div>
    ...
    <div class="carousel-item">
    	<div class="container0">
      <img class="d-block w-100" src="<?php echo e(asset(Helper::getBackgroundImage($banner2))); ?>" alt="Second slide">
    ...
    <div class="carousel-item">
    	<div class="container0">
      <img class="d-block w-100" src="<?php echo e(asset(Helper::getBackgroundImage($banner3))); ?>" alt="Third slide">
...
-->
    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:380px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:380px;overflow:hidden;">
            <div data-p="680">
                <img data-u="image" src="<?php echo e(asset('stock_shop/img/moisture.jpg')); ?>" />
            ...
            <div data-p="680">
                <img data-u="image" src="<?php echo e(asset('stock_shop/img/juice.jpg')); ?>" />
                ...
                <svg viewbox="0 0 52 31" width="52" height="31" data-tchd="jssor_1_msk_2" style="left:766px;top:322px;display:block;position:absolute;overflow:visible;">
                    <g fill="rgb(0, 0, 0)" stroke="none" stroke-width="1" mask="url(#jssor_1_msk_2)">
                        <image data-load="href" width="63" height="20" filter="url(#jssor_1_flt_1)" x="-20" y="10" data-t="6" data-tsep="jssor_1_gbl_1" style="position:absolute;opacity:0;max-width:63px;" href="<?php echo e(asset('stock_shop/img/juce-pomegranate-shadow.png')); ?>"></image>
                    </g>
                </svg>
                    ...
                    <g mask="url(#jssor_1_msk_8)">
                        ...
                        <svg viewbox="0 0 260 130" data-ts="preserve-3d" x="0" y="0" width="260" height="130" style="position:absolute;overflow:visible;">
                            <g filter="url(#jssor_1_flt_3)">
                                <image data-load="href" width="370" height="100" x="-66" y="35" style="position:absolute;max-width:370px;" href="<?php echo e(asset('stock_shop/img/fruit-splash.png')); ?>"></image>
            ...
            <div data-p="680">
                <img data-u="image" src="<?php echo e(asset('stock_shop/img/makeup.jpg')); ?>" />
                    ...
                    <g>
                        <svg viewbox="0 0 980 380" data-ts="preserve-3d" x="0" y="0" width="980" height="380" data-tchd="jssor_1_msk_9" style="position:absolute;overflow:visible;">
                            <g mask="url(#jssor_1_msk_9)">
                                <image data-load="href" width="980" height="380" data-to="484.0px 428.0px" x="-6" y="10" data-t="18" style="position:absolute;opacity:0;max-width:980px;" href="<?php echo e(asset('stock_shop/img/makeup-items.png')); ?>"></image>
                                <image data-load="href" width="96" height="45" data-to="423px 366px" x="375" y="344" data-t="19" style="position:absolute;opacity:0;max-width:96px;" href="<?php echo e(asset('stock_shop/img/makeup-lipstick-1.png')); ?>"></image>
                                <image data-load="href" width="98" height="86" data-to="424px 387px" x="375" y="344" data-t="20" style="position:absolute;opacity:0;max-width:98px;" href="<?php echo e(asset('stock_shop/img/makeup-lipstick-2.png')); ?>"></image>
                                <image data-load="href" width="101" height="122" data-to="425px 381px" x="375" y="320" data-t="21" style="position:absolute;opacity:0;max-width:101px;" href="<?php echo e(asset('stock_shop/img/makeup-lipstick-3.png')); ?>"></image>
                                <image data-load="href" width="52" height="77" data-to="482px 428px" x="456" y="390" data-t="22" style="position:absolute;opacity:0;max-width:52px;" href="<?php echo e(asset('stock_shop/img/makeup-lipstick-4.png')); ?>"></image>
                                <image data-load="href" width="23" height="18" data-to="497px 435px" x="486" y="426" data-t="23" style="position:absolute;opacity:0;max-width:23px;" href="<?php echo e(asset('stock_shop/img/makeup-petal-1.png')); ?>"></image>
                                <image data-load="href" width="19" height="19" data-to="502px 434px" x="493" y="425" data-t="24" style="position:absolute;opacity:0;max-width:19px;" href="<?php echo e(asset('stock_shop/img/makeup-petal-2.png')); ?>"></image>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-8 push-md-2 col-lg-6 push-lg-3">
                            <div class="wt-sectionhead wt-textcenter">
                                <div class="wt-sectiontitle">
                                    <h2><?php echo e(trans('lang.our_courses')); ?></h2>
