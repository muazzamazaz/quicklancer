    ...
    <div class="wt-settingscontent">
        <div class="wt-formtheme wt-userform">
            <div class="form-group">
                <?php echo Form::text('home[0][app_title]', e($app_title), array('class' => 'form-control')); ?>
...
<div class="wt-location wt-tabsinfo">
    ...
    <div class="wt-settingscontent">
        <div class="wt-formtheme wt-userform">
            <div class="form-group">
                <?php echo Form::text('home[0][app_subtitle]', e($app_subtitle), array('class' => 'form-control')); ?>
...
<div class="wt-location wt-tabsinfo">
    ...
    <div class="wt-settingscontent">
        <div class="wt-formtheme wt-userform">
            <div class="form-group">
                <?php echo Form::textarea('app_desc', e($app_desc), array('class' => 'form-control wt-tinymceeditor', 'id' => 'wt-tinymceeditor')); ?>
