        ...
        <div class="wt-accordioninnertitle">
            ...
            <div class="wt-collapseexp collapse hide" :id="this.inner_accordion_id" :aria-labelledby="this.main_accordion_id" data-parent="#accordion">
                <fieldset>
                    ...
                    <div class="form-group form-group-half">
                        <input type="text" :value="this.stored_project_url" v-bind:name="this.project_url_name" class="form-control" placeholder="Project URL">
                    </div>
...
export default {
    props: ['dropzone_id', 'img_hidden_id', 'img_hidden_name', 'img_ref', 'main_accordion_id', 'inner_accordion_id', 'stored_project_title', 'stored_project_url', 'stored_project_img', 'project_title_name', 'project_url_name', 'previewer_class', 'remove_uploded_image_id', 'uploaded_image_remove_id'],    
    components: {
