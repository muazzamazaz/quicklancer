<template>
    <div>
        <div class="wt-dashboardboxtitle wt-titlemessages" v-if="user">
            ...
            <a :href="url+'/profile/'+user.selected_user_slug" class="wt-viewprofile">View Profile</a>
        </div>
        <div class="wt-dashboardboxcontent wt-dashboardholder wt-offersmessages">
            <ul v-if="users">
                ...
                <li>
                    <chat-area :empty_error="this.empty_field"></chat-area>
                </li>
            </ul>
