<template>
    <div>
        ...
        <div class="wt-insightdetails">
            <div class="wt-title" v-if="this.trail == 'true'">
                <h3>{{this.title}}</h3>
                <a :href="this.package_url">Upgrade Now</a>
            </div>		
            <div class="wt-title" v-else>
                <h3>{{this.title}}</h3>
                <a :href="this.package_url" v-if="this.expire == true">Upgrade Now</a>
            </div>													
        </div>	
    </div>
</template>
