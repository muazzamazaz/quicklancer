    ...
    <div>
        ...
        <ul class="wt-experienceaccordion accordion" id="education-list">
            <span v-if="stored_educations" class="education-inner-list">
                 <li v-for="(stored_education, index) in stored_educations" :key="index" class="education-element">
                     <div class="wt-accordioninnertitle">
                        <span :id="'educationaccordion-'+index+''" data-toggle="collapse" :data-target="'#educationaccordioninner-'+index+''">{{stored_education.degree_title}} ({{stored_education.start_date}} - {{stored_education.end_date}})</span>
                        <div class="wt-rightarea">
                            <a href="javascript:void(0);" class="wt-addinfo wt-skillsaddinfo" :id="'educationaccordion-'+index+''" data-toggle="collapse" :data-target="'#educationaccordioninner-'+index+''" aria-expanded="true"><i class="lnr lnr-pencil"></i></a>
                            <a href="javascript:void(0);" class="wt-deleteinfo" @click="removeStoredEducation(index)"><i class="lnr lnr-trash"></i></a>
                        </div>
                    </div>
                    <div class="wt-collapseexp collapse hide" :id="'educationaccordioninner-'+index+''" :aria-labelledby="'educationaccordion-'+index+''" data-parent="#accordion">
                        <fieldset>
            ...
            <span class="education-inner-list">
                <li v-for="(education, index) in educations" :key="index" ref="educationlistelement" class="education-inner-list-item">
                    <div class="wt-accordioninnertitle">
                        <span :id="'educationaccordion-'+education.count+''" data-toggle="collapse" :data-parent="'#educationaccordioninner-'+education.count+''">
                            {{education.degree_title}} ( {{education.start_date}} - {{education.end_date}} )
                        </span>
                        <div class="wt-rightarea">
                            <a href="javascript:void(0);" class="wt-addinfo wt-skillsaddinfo" :id="'educationaccordion-'+education.count+''" data-toggle="collapse" :data-target="'#educationaccordioninner-'+education.count+''" aria-expanded="true"><i class="lnr lnr-pencil"></i></a>
                            <a href="javascript:void(0);" class="wt-deleteinfo delete-education"><i class="lnr lnr-trash"></i></a>
                        </div>
                    </div>
                    <div class="wt-collapseexp collapse hide" :id="'educationaccordioninner-'+education.count+''" :aria-labelledby="'educationaccordion-'+education.count+''" data-parent="#accordion">
                        <fieldset>
                            <div class="form-group form-group-half">
                                <input type="text" v-bind:name="'education['+[education.count]+'][degree_title]'" class="form-control" :placeholder="ph_job_title" v-model="education.degree_title">
                            </div>
                            <div class="form-group form-group-half">
...
export default{
    ...
    props: ['widget_title', 'ph_job_title', 'ph_institute_title', 'ph_desc', 'ph_degree_title'],
        data(){
            return {
                start_date: '',
                end_date: '',
        ...
        methods: {
            ...
            addEducation: function () {
                var education_list_count = jQuery('.add-education-btn').parents('.wt-tabsinfo').find('ul#education-list span.education-inner-list li').length;
                ...
                this.educations.push(Vue.util.extend({}, this.education, this.education.count++))
            },
