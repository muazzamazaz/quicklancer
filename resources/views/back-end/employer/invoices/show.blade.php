                    ...
                    <div class="wt-transactioncontent" id="printable_area">
                        <ul class="wt-transactiondetails">
                            ...
                            <li>
                                ...
                                <span class="wt-grossamount wt-grossamountusd">{{{ $symbol }}}{{{$invoice_info->price}}}&nbsp;{{{ $invoice_info->currency_code }}}</span>
                            </li>
                            <li>
                        ...
                        <table class="table wt-carttable">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td data-title="Total">{{ $symbol }}{{{ $invoice_info->item_price }}}&nbsp;{{ $invoice_info->currency_code }}</td>
                                    <td data-title="Total">{{ $symbol }}{{{ $invoice_info->item_price }}}&nbsp;{{ $invoice_info->currency_code }}</td>
                                </tr>
                                <tr>
                            ...
                            <tbody>
                                <tr>
                                    <td data-title="Product Name">
                                        ...
                                        <span>{{ $symbol }}{{{ $invoice_info->item_price }}}&nbsp;{{ $invoice_info->currency_code }}</span>
                                    </td>
                                    <td data-title="Unit Price"></td>
                                ...
                                <tr>
                                    <td data-title="Product Name">
                                        ...
                                        <span>{{ $symbol }}{{{$invoice_info->sales_tax}}} {{ $invoice_info->currency_code }}</span>
                                    </td>
                                    <td data-title="Unit Price"></td>
                                    <td data-title="Total"></td>
                                    <td data-title="Total"></td>
                                ...
                                <tr>
                                    <td data-title="Product Name">
                                        ...
                                        <span>{{ $symbol }}{{{$invoice_info->price}}} {{ $invoice_info->currency_code }}</span>
                                    </td>
                                    <td data-title="Unit Price"></td>
                                    <td data-title="Total"></td>
                                    <td data-title="Total"></td>
