                                            ...
                                            @if (!empty($job->price) || 
                                                ...
                                                <ul class="wt-userlisting-breadcrumb">
                                                    ...
                                                    @if (!empty($job->location->title))
                                                        <li><span><img src="{{{asset(App\Helper::getLocationFlag($job->location->flag))}}}" alt="{{{ $job->location->title }}}"> {{{ $job->location->title }}}</span></li>
                                                    @endif
                                                </ul>
                                            @endif
                                        </div>
                                    ...
                                    <div class="wt-userlistinghold wt-featured wt-proposalitem">
                                        ...
                                        <div class="wt-proposaldetails">
                                            ...
                                            <div class="wt-proposalfeedback">
                                                ...
                                                @endif
                                                <span class="wt-starcontent">{{{ $rating }}}&nbsp;<em> ({{{ $reviews }}})</em></span>
                                            </div>												
                                        </div>
                                        <div class="wt-rightarea wt-titlewithsearch">
                                            ...
                                            @endif
                                            <div class="wt-hireduserstatus">
                                                <h5>&#36;{{{ $accepted_proposal->amount }}}</h5>
